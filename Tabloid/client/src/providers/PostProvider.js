...
export const PostProvider = (props) => {
    ...
    return (
        ...
        <PostContext.Provider value={{ posts, getAllPosts, post, getPost, addPost, searchPosts, setSearchTerms, searchTerms, getPostsWithComments, getMyPosts, setPost, editPost }}>
            {props.children}
